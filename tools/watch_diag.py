...
left, top, right, bottom = bv.find_board(shot)
print(f"located board at: ({left}, {top}) -> ({right}, {bottom})  side ~{right - left}px")
...
fen = bv.image_to_fen(crop, prof, white_bottom=prof.white_bottom).split()[0]
